...
namespace HotdRemake_ArcadePlugin_202207
{
    ...
    public class HotdRemake_ArcadePlugin : BaseUnityPlugin
    {
        ...
        public static void SetConfigValues(MegaPixel.SaveLoadSystem.MP_SaveData LoadedData)
        {
            ...
            LoadedData.GameSettings.PlayerOneGameplaySettings.CrosshairDisabled = Configurator.HideCrosshairs;
            LoadedData.GameSettings.PlayerTwoGameplaySettings.CrosshairDisabled = Configurator.HideCrosshairs;
            LoadedData.GameSettings.PlayerOneGameplaySettings.UseVibrations = false;
            LoadedData.GameSettings.PlayerTwoGameplaySettings.UseVibrations = false;

            LoadedData.GameSettings.ChangeBloodColor = true;
            LoadedData.GameSettings.UseRandomBloodColor = false;
            LoadedData.GameSettings.BloodColor = HotdRemake_ArcadePlugin.Configurator.BloodColor == 1 ? MP_SerializableColor.Green : MP_SerializableColor.Red;
