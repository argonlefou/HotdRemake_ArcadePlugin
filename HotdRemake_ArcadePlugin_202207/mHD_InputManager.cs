    ...
    class mHD_InputManager
    {
        ...
        class handleControlInputsOfPlayer
        {
            static bool Prefix(HD_InputManager __instance, Player[] ___playerInputs, int _playerIndex, bool _canSkipCutscene = true)
            {
                ...
                if (mIsPauseToggled.isPauseToggled(__instance, (PlayerType)_playerIndex, player))
                {
                ...
                {
                    HD_CutsceneInputManager.HandleInputs((PlayerType)_playerIndex, player);
                }
                return false;
            }
        }
        ...
        class mIsPauseToggled
        {
            ...
            public static bool isPauseToggled(object instance, PlayerType _playerType, Player _playerInput)
            {
